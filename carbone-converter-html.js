...
export const options = {
  ...
  thresholds: {
    ...
    carbone_html_latency: ['p(95)<5000'],     // custom metric threshold
  },
};

// Custom metric to track Carbone latency explicitly
const carboneLatency = new Trend('carbone_html_latency');

const url = 'http://localhost:4000/render/template?download=true';
// k6 reads the file once at init time and reuses the buffer
const fileData = open('./sampleBase64.html');

// MIME type for HTML
const HTML_MIME = 'text/html';
const HtmlBase64 = `data:${HTML_MIME};base64,${fileData}`;
