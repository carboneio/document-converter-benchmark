...
export const options = {
  ...
  thresholds: {
    ...
    jodconverter_latency: ['p(95)<5000'],     // custom metric threshold
  },
};

// Custom metric to track JODConverter latency explicitly
const jodLatency = new Trend('jodconverter_latency');

const url = 'http://localhost:8080/lool/convert-to/pdf';
...
export default function () {
  ...
  // Record latency
  jodLatency.add(res.timings.duration);
